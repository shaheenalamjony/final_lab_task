          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              ...
              <div class="row register-form">
                ...
                <!-- form start -->
                <form action="../controller/studentAction.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="sid" type="text" name="sid" placeholder="sid"> <br><br>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="email" type="text" name="email" placeholder="Email"> <br><br>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="sec" type="text" name="sec" placeholder="Sec"> <br><br>
