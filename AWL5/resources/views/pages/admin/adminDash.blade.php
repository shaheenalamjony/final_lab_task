...
/* @import url(https://pngtree.com/freepng/avatar-icon-profile-icon-member-login-vector-isolated_5247852.html); */
/* background: url("../image/Online-Education.jpg") ; */
/* .container {
  display: grid;
...
.grid-container {
  ...
  <div class="grid-container">
    ...
    <button class="btn draw-border">{{Session::get('admin')}} </button> 
